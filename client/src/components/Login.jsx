    ...
    return (
        ...
        >
            ...
            >
                ...
                {state !== "Login" &&
                    <div className='border pl-3 pr-6 py-2 flex items-center gap-2 rounded-full mt-5'>
                        {/* <img src={assets.profile_icon} alt="" width={32}/> */}
                ...
                <div className='border pl-3 pr-6 py-2 flex items-center gap-2 rounded-full mt-4'>
